...
**AutoAS is an autonomous research agent that turns a long-horizon objective into a
...
Instead of one-shot attempts that forget what failed, AutoAS grows a **hypothesis tree**:
...
-   :material-rocket-launch: **Get running in minutes**
    ...
    `pip install autoas-agent`, `autoas setup`, then `autoas`.

    [:octicons-arrow-right-24: Installation](installation.md)

-   :material-flask: **Run your first study**

    Point AutoAS at a benchmark and watch the Idea Tree grow.

    [:octicons-arrow-right-24: Quickstart](quickstart.md)

-   :material-sitemap: **Understand the method**

    The autoas cycle, the Idea Tree, git isolation, and held-out discipline.
...
| Agent | Role |
| --- | --- |
| **Coordinator** | The research director. Maintains the Idea Tree, drives the search via the *autoas cycle*, and dispatches experiments. |
