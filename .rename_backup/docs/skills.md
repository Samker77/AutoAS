...
!!! question "Do I need to write one?"
    **No.** AutoAS ships with sensible default Skills that load automatically. Write your own
...
AutoAS ships a small set of Skills out of the box, loaded automatically:
...
1. Create the folder `.autoas/skills/` inside your project and add a markdown file
   there, e.g. `<project>/.autoas/skills/my_skill.md`. AutoAS discovers project
