# Benchmark backlog — candidates for `autoas benchmark add`
...
Columns: **angle** = what AutoAS edits (the pack); **frozen** = the freeze axis;
...
rather than optimizing an artifact, or need hardware/sim AutoAS can't drive.
