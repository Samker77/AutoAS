"""`autoas config` — view and edit user-level defaults."""
...
def write_user_llm_config(llm: dict[str, Any]) -> None:
    ...
    Shared by ``autoas config init`` and the interactive ``autoas setup`` wizard so
