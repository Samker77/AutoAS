"""`autoas export` — export a run session to HTML or JSONL."""
...
def export_command(
    ...
    output: Optional[Path] = typer.Argument(
        None,
        help="Output path. Defaults to <session>/autoas-session-<name>.html. Use .jsonl for JSONL.",
    ),
    ...
    """Export a previous AutoAS session for review or sharing."""
