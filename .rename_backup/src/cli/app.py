"""Top-level Typer app for the autoas CLI."""
...
# handling for `autoas --help`. Instead, we detect the no-subcommand case
...
def main() -> None:
    ...
    If invoked with no subcommand (e.g. `autoas` or `autoas --cwd .`),
