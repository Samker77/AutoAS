    ...
    def _check_llm(self) -> CheckResult:
        ...
        if self.provider not in self._PROVIDER_ENV:
            return CheckResult(
                ...
                hint="run `autoas setup` and choose anthropic, openai, or litellm",
            )
        ...
        if env_vars is None:
            ...
            return CheckResult(
                ...
                hint="set ANTHROPIC_API_KEY / OPENAI_API_KEY, or run `autoas setup`",
            )
        ...
        return CheckResult(
            ...
            hint=f"export {primary}=... or run `autoas setup`",
        )
