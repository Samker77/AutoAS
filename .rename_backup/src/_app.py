...
TAGLINE = "Plan. Execute. Learn. Repeat."
TAGLINE_SUB = "Every hypothesis becomes a branch — pruned if it fails, harvested if it works."

CONFIG_DIR_NAME = f".autoas"
CONFIG_FILE_NAME = "autoas.yaml"

GLOBAL_CONFIG_DIR = Path.home() / ".autoas"
...
LEGACY_GLOBAL_CONFIG_DIR = Path.home() / ".autoas"
