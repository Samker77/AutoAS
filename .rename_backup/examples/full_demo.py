...
canned MOCK_SCRIPT (autoas.events.mock) onto a single EventBus. Because
...
from autoas.cli.run_dashboard import RunDashboard
from autoas.cli.run_state import RunState
from autoas.events import EventBus
from autoas.events.mock import emit_mock_run
...
def main() -> None:
    ...
    webui = None
    if port is not None:
        from autoas.webui import WebUIServer
